...
| Family | Entry point |
| --- | --- |
| Base CoMem, selection, and resumed decoding | [`comem/model.py`](../comem/model.py), [`selectors.py`](../comem/selectors.py) |
| Base LoRA distillation | [`train/distill.py`](../train/distill.py) |
| 9B/27B backbone training and evaluation | [`comem_new_backbones_formal_20260915`](../research/dependencies/comem_new_backbones_formal_20260915/) |
| Original hybrid reader and model preparation | [`comem_new_backbones_20260915`](../research/dependencies/comem_new_backbones_20260915/) |
...
| Full89 Dense / CoMem k12 / k48 | [`server_control_20260920`](../research/server/terminal_bench_full89_20260919/server_control_20260920/) |
| GPU kernel, same-Transformers TPS, PEFT and Hot-merged pilots | [`comem_vllm_pilot_20260922`](../research/server/terminal_bench_full89_20260919/server_control_20260920/comem_vllm_pilot_20260922/) |
...
`comem_vllm_pilot_20260922/prototype` contains the kernel adapter prototypes and
PEFT helper; its `attempts` directories preserve the tested implementations.
The kernel pilots did not establish a full vLLM CoMem runner. The Hot24 merged
