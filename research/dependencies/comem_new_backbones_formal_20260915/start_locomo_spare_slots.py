...
#SBATCH --output=/srv/encbank/comem_new_backbones_formal_20260915/locomo-release-%j.out
#SBATCH --error=/srv/encbank/comem_new_backbones_formal_20260915/locomo-release-%j.err
set -euo pipefail
cd /srv/encbank/comem_new_backbones_formal_20260915
