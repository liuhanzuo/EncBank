...
ARMS=('dense_stock','dense_shared','replay_read','encbank_read','replay_ttft','encbank_ttft')
records=[]; metadata=[]
...
speedups={'same_adapter_full_vs_encbank_read':summary['dense_shared']['latency_ms']/summary['encbank_read']['latency_ms'],'stock_full_vs_encbank_read':summary['dense_stock']['latency_ms']/summary['encbank_read']['latency_ms'],'same_pack_depth_read':summary['replay_read']['latency_ms']/summary['encbank_read']['latency_ms'],'same_pack_ttft':summary['replay_ttft']['latency_ms']/summary['encbank_ttft']['latency_ms']}
