...
The section is due for a restructure into two prior-work problems plus one Encbank problem once
...
for old, new in (("\\emph{Gap (i).} The base Encbank paper", "The base Encbank paper"),
                 ("\\emph{Gap (i), continued.} A Encbank read pack", "A Encbank read pack")):
    if s.count(old) != 1:
