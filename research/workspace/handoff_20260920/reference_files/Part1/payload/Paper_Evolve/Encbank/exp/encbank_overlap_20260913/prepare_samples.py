...
def main():
    tok=AutoTokenizer.from_pretrained(os.environ['ENCBANK_MODEL'],local_files_only=True)
    ...
    path=HERE.parent/'encbank_frozen_j12_20260912/data/longbench/qasper.jsonl'
