...
#   none/kvdirect/hcache -> Encbank re-parameterisations,
#   dense/streamingllm   -> stock full-context arms,
#   snapkv/pyramidkv     -> prefill-then-compress KV baselines (encbank.kvcompress),
#   cacheblend           -> full-depth chunk-KV baseline (encbank.cacheblend).
...
def add_baseline_args(p):
    ...
    p.add_argument("--kv_budget", type=int, default=6657,
                   help="snapkv/pyramidkv: retained KV tokens per layer including "
                        "the observation window (default 6657 == Encbank's read "
