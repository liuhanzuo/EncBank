...
five families that used to sit above the Encbank subsection. With that paragraph gone they point
...
EDITS = [
    ("Encbank's mechanism is therefore the third line's\nhidden-state recompute made retrievable and bounded",
     "Encbank's mechanism is therefore hidden-state caching with\nupper-layer recompute, made retrievable and bounded"),
