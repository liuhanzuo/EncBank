"""Frozen j=12 accuracy remeasurement using the released Encbank prompt path.
...
def main():
    ...
    cm=Encbank(model,12,tokenizer=tok); rp=Encbank(model,0,tokenizer=tok)
