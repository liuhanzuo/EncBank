...
WHY IT WAS WRONG. `fix_none` is built as `EncbankLower(model, j, tok, lower_layers=[])`
(s15_ruler_lower.py:321-323) and `EncbankLower.__init__` defaults `chunk_write_sink=True`
