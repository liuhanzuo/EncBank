...
for r in records:
    ...
    expected = {'replay': 8, 'encbank': 8192, 'chunkkv': 147456}[r['method']]
...
for cell in CELLS:
    ...
    for on in (False, True):
        for method in ('replay', 'chunkkv', 'encbank'):
...
for cell in CELLS:
    ...
    for on in (False, True):
        for method in ('replay', 'chunkkv', 'encbank'):
            ...
            name = {'replay': 'Replay', 'chunkkv': 'Chunk-KV', 'encbank': 'Encbank' if on else 'Encbank (without LoRA)'}[method]
