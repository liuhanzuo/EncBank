...
VERSION = "sparse-encbank-fixed-pack-reuse-v1"
QUALITY_VERSION = "sparse-encbank-trained-reuse-quality-v1"
...
def source_identity():
    ...
    result["encbank/model.py"] = digest(HERE.parents[1] / "Encbank/encbank/model.py")
    result["train_8b_baseline.py"] = digest(HERE.parent / "encbank_v2_benchmarks_20260908/train_8b_baseline.py")
    return result
