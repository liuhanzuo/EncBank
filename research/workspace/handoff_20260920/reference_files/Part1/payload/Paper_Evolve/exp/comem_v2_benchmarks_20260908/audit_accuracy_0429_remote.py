...
dest=R/'outputs/diagnostics/heartbeat_accuracy_20260909_0429_qa.json';tok=AutoTokenizer.from_pretrained(R/'models/Qwen3-8B',local_files_only=True)
audited={};configs={}
for task,arms,n in [('narrativeqa',('pub','pub_sink','cbos'),200),('hotpotqa',('pub_sink','cbos'),200)]:
  for arm in arms:
...
for task,arms,n in [('narrativeqa',('pub','pub_sink','cbos'),200),('hotpotqa',('pub_sink','cbos'),200)]:
  references=['fix_all','j0']+(['fix_none','pub'] if task=='hotpotqa' else [])
