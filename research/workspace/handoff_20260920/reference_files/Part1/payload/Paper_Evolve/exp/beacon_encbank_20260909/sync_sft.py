...
REMOTE_ROOT = "/data/liuhanzuo/encbank_v2_20260908/outputs/beacon_sft_20260909"
 ...
 for pid in pids:
  ...
  try:
   ...
   processes[str(pid)]={{'exists':True,'state':state,'alive':state!='Z',
       'matches_sft_task':('/beacon_encbank_20260909/' in command and ('train_sft.py' in command or 'remote_sft_queue.py' in command))}}
