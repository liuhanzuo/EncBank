...
files=['config.py','train_support.py','kv_reference.py','comem_training_metadata.json',
 'comem_adapter_config.json','trainable_cacheblend.py','test_trainable.py','train_cacheblend.py',
