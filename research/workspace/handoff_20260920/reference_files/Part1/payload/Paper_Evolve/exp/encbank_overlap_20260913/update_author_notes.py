...
s=s.replace('the fixed-w32 LongEval/Qasper repair experiment is now running under `exp/encbank_overlap_20260913`; other accuracy experiments remain proposals.','the fixed-w32 LongEval/Qasper quality experiment has completed under `exp/encbank_overlap_20260913` and is included in the manuscript. Local Write-inclusive cost measurements are still running; other proposed accuracy experiments remain unrun. See `OVERLAP_CONFIRMATION_zh.md`.')
...
p.write_text(s,encoding='utf-8')
p=ROOT/'exp/encbank_overlap_20260913/PROTOCOL_zh.md';s=p.read_text(encoding='utf-8')
