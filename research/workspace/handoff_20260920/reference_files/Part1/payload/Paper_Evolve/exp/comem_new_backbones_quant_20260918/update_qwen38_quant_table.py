...
p=ROOT.parent/'comem_new_backbones_formal_20260915/delivery/FIVE_BENCHMARK_RESULTS_zh.md'
...
for bit in [8,4]:
    prefix='| Qwen3.8-27B | CoMem-H%d |'%bit
...
anchor='| Qwen3.5-9B | CoMem-H4 | 46.78 | 56.62 | 12.78 |'
assert text.count(anchor)==1
rows=[]
for bit in [8,4]:
    d=s['locomo_breakdown']['cache_h%d'%bit]
    rows.append('| Qwen3.8-27B | CoMem-H%d | %.2f | %.2f | %.2f |'%(bit,d['all']['score'],d['C1-4']['score'],d['C5']['score']))
...
assert text.count(anchor)==1
sources='27B来源：[全五项汇总与核验](F:/Paper_Evolve/exp/comem_new_backbones_quant_20260918/delivery/qwen38_quant_five_benchmarks/summary.json)、[原始预测及评分交付包](F:/Paper_Evolve/exp/comem_new_backbones_quant_20260918/delivery/qwen38_quant_five_benchmarks/saved_outputs.tar.gz)、[逐题LoCoMo判分](F:/Paper_Evolve/exp/comem_new_backbones_quant_20260918/delivery/qwen38_quant_five_benchmarks/judge_decisions.jsonl)、[任务正常退出证据](F:/Paper_Evolve/exp/comem_new_backbones_quant_20260918/delivery/qwen38_quant_five_benchmarks/exit_evidence.json)。\n\n'
