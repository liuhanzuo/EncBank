...
dest=R/'outputs/diagnostics/heartbeat_accuracy_20260909_0329_qa.json';tok=AutoTokenizer.from_pretrained(R/'models/Qwen3-8B',local_files_only=True)
audited={};configs={}
for task,arms,n in [('2wikimqa',('pub','pub_sink','cbos'),200)]:
  for arm in arms:
