...
Uses the stock Encbank upper reader, but does not import/patch s15_ruler_lower or
...
sys.path.insert(0, str(WORKSPACE / "Encbank"))
from encbank.model import Encbank


class DenseLlamaCandidate(Encbank):
