"""Full-conversation SFT on CoMem memory, with bounded vocabulary activations.
...
def conversation_loss(net, document_chunks, query_ids, labels, *, head_chunk_size=128):
    ...
    The connective, b=0 CoMem path is required. We preserve its causal attention
    ...
    if reader.top_prepay_b != 0 or reader.block_diagonal:
        raise ValueError("Official SFT requires ordinary connective CoMem, b=0")
