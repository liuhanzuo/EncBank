...
MAX_NEW_TOKENS = 20  # Encbank eval/babilong.py default, not a universal benchmark rule.
...
def format_prompt(row: dict, task: str) -> str:
    """Exact Encbank default official template: instructions/examples/post-prompt, no chat."""
