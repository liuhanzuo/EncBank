...
FOLLOW = ROOT.parent/'encbank_followups_20260913' if os.name == 'nt' else Path('/srv/encbank/encbank_followups_20260913')
sys.path.insert(0, str(FOLLOW/'Encbank'))
...
TOKEN_CACHE = '/srv/encbank/encbank_cacheblend_lora_20260916/training/pg19_tokens.u32'
PRINCIPAL = '/srv/encbank/encbank_infra_recheck_20260912/adapter'
