...
dest=R/'outputs/diagnostics/heartbeat_accuracy_20260909_0229_qasper_cbos.json';tok=AutoTokenizer.from_pretrained(R/'models/Qwen3-8B',local_files_only=True)
audited={};configs={}
for task,arms,n in [('qasper',('cbos',),200)]:
  for arm in arms:
