...
dest=R/'outputs/diagnostics/heartbeat_accuracy_20260909_0329_hotpot_pub.json';tok=AutoTokenizer.from_pretrained(R/'models/Qwen3-8B',local_files_only=True)
audited={};configs={}
for task,arms,n in [('hotpotqa',('pub',),200)]:
  for arm in arms:
...
for task,arms,n in [('hotpotqa',('pub',),200)]:
  references=['fix_all','j0']+(['fix_none'] if task=='hotpotqa' else [])
