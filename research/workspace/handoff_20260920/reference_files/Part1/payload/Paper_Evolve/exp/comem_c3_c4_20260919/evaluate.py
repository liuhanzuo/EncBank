"""Each independently trained adapter: matched j=0 raw and own-j CoMem, fixed 400 inputs."""
...
def main():
    ...
    atomic_json(out/'protocol.json',dict(j=a.j,adapter_layers=list(range(18,36)),rank=32,alpha=32,steps=4000,
        ...
        arms=['raw','comem'],rows_per_arm=400,gpu=torch.cuda.get_device_name(),job=os.environ['SLURM_JOB_ID'],
