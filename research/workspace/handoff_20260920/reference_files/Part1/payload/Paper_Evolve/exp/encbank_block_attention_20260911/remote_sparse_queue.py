"""Bounded remote RTX 3090 queue for the isolated sparse-Encbank pilot.
...
def main():
    ...
    parser.add_argument('--out', type=Path, default=ROOT/'outputs/sparse_encbank_20260911')
    ...
    task_lock = (ROOT/'logs'/'sparse_encbank_20260911.queue.lock').open('a')
        ...
        while True:
            ...
            for name, item in jobs.items():
                ...
                env = {**os.environ, 'CUDA_VISIBLE_DEVICES': str(gpu), 'OMP_NUM_THREADS': '2',
                       ...
                       'SPARSE_ENCBANK_QUEUE_TASK': 'sparse_encbank_20260911',
