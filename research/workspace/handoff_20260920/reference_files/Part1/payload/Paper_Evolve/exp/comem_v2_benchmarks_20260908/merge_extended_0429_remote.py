...
B=Path('/data/liuhanzuo/comem_v2_20260908/workspace/exp/comem_v2_benchmarks_20260908')
...
out+=['','`pub`=原始CoMem；`pub_sink`=CoMem+BOS；`cbos`=isolated full KV控制，不能当作CacheBlend。实测0保留0；没有把未知或未完成项写为0。','',
...
out+=['','没有显著性检验，也不从该单任务推断整个InfiniteBench或跨任务绝对优势。MC基线未完整，继续空白。', '',
      ...
      'LongEval是CoMem adaptation：random-letter label、six-digit value、completion prompt、首个至少四位数精确匹配，非官方LongChat模板/评分；stock模型、seed1234、chunk512、BM25 top12、cap16。**完整token与exact-input缓存检查不等于runtime selected-pack验证**；原日志没有存selected indices/完整runtime pack。', '',
