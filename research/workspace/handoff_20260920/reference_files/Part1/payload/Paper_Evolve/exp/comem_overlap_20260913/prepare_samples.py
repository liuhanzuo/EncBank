...
def main():
    ...
    path=HERE.parents[1]/'comem_frozen_j12_20260912/data/longbench/qasper.jsonl'
    if not path.exists():path=HERE.parent/'comem_frozen_j12_20260912/data/longbench/qasper.jsonl'
