...
for task,arms,n in [('multifieldqa_en',('fix_all','j0'),150),('hotpotqa',('fix_none',),200)]:
  for arm in arms:
    ...
    for shard in range(2):
      ...
      if arm=='j0':assert marker['reader']['class']=='Encbank' and marker['reader']['effective_j']==0 and marker['reader']['write_sink'] is False
      else:assert marker['reader']['class']=='EncbankLower' and marker['reader']['effective_j']==12 and marker['reader']['write_sink'] is True
