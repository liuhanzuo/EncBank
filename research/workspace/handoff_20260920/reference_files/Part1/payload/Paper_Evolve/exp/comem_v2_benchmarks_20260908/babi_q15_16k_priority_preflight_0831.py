...
from babi_q15_16k_priority_bootstrap import R,B,read,alive,verify_scope,verify_predecessor,launch_allowed
...
plan=read(B/'babi_q15_16k_priority_full_plan.json');main=read(B/'full_plan.json');state=read(R/'outputs/queue_v2/full/state.json')
...
if args.launch:
    ...
    argv=[sys.executable,'-u',str(B/'babi_q15_16k_priority_bootstrap.py')]
    attempt=1
...
name='heartbeat_babi_q15_16k_priority_20260909_0831_launch.json' if args.launch else 'heartbeat_babi_q15_16k_priority_20260909_0831_preflight.json'
