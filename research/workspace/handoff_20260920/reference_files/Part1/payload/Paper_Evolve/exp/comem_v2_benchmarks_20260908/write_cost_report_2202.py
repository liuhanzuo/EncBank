...
names = {'pub': 'CoMem', 'pub_sink': 'CoMem + sink', 'pub_lora': 'CoMem + LoRA', 'j0': 'Full recompute (j0)', 'fix_all': 'CoMem V2'}
arms = tuple(names)
lines = [
...
lines += ['', 'Each newly completed job has an effective 5.0 GiB ceiling, strict comparison, nvidia-smi MiB/1024 units, and no other Python compute process at admission. The earliest accepted V2 32k and CoMem 32k runs predate structured dual-check recording: their legacy gate logs report lock acquisition with approximately 3.9 and 2.8 GiB used, respectively. Do not claim that their exact initial and locked-recheck values were recorded. All later accepted runs have structured admission evidence.', '',
'## Reporting boundary', '',
