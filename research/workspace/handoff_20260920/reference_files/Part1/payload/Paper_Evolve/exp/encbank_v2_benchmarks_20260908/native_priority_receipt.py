...
def completed(job):
    ...
    if arm in ('fix_all','fix_none'):want=('EncbankLower',12,True)
    elif arm=='cbos':want=('EncbankLower',36,True)
    elif arm=='j0':want=('Encbank',0,False)
    elif arm in ('pub','pub_sink'):want=('Encbank',12,arm=='pub_sink')
