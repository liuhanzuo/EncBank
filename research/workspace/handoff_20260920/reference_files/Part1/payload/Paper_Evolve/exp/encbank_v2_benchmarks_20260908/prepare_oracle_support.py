...
def build_plans(inputs, manifest, remote_root):
    ...
    scripts = workspace + "/exp/encbank_v2_benchmarks_20260908"
    for mode in ("smoke", "full"):
        plan = {"schema_version": 1, "cwd": workspace, "workspace_root": workspace,
            ...
            "env": {"ENCBANK_REMOTE_QUEUE": "1", "PAPER_EVOLVE_ALLOW_8B": "1", "TOKENIZERS_PARALLELISM": "false"},
...
def main():
    ...
    p.add_argument("--remote-root", default="/data/liuhanzuo/encbank_v2_20260908")
