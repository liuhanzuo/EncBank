...
def main():
    ...
    text+='\n参考[Twilight论文](https://papers.nips.cc/paper_files/paper/2025/file/ad2f57116d62a9d8dcfaba6a168715e4-Paper-Conference.pdf)的先选择后top-p裁剪；本实现是COMem块级检索变体，不是原生Twilight复现。\n'
