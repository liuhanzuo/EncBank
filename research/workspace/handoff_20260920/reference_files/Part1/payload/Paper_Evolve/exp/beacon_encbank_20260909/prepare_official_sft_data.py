"""Lossless raw-data references and conservative native Encbank SFT conversion.
...
def parse_record(record: Mapping, source: str, source_index: int, *, seed: int = 42,
    ...
    conversation = {
        "format": "official-beacon-encbank-native-v1", "conversation_id": conversation_id,
...
def prepare_corpus(raw_dir: str | Path, output_dir: str | Path, *, seed: int = 42,
    ...
    report = {
        "format": "official-beacon-encbank-native-v1", "dataset_id": DATASET_ID, "dataset_revision": DATASET_REVISION,
