...
for name in ('sections/tab_infra.tex','sections/tab_local_infra_processes.tex','README.md'):
    ...
    s=s.replace('its natural-task repair and additional accuracy experiments remain proposals.','the fixed-w32 LongEval/Qasper repair experiment is now running under `exp/comem_overlap_20260913`; other accuracy experiments remain proposals.')
...
for name in ('comem_infra_20260912/aggregate.py','comem_infra_20260912/tab_infra_template.tex','comem_dense5090_20260913/update_paper.py','comem_b300_recheck_20260912/update_paper.py'):
