...
OUT = ROOT / "outputs/diagnostics/heartbeat_babilong_20260909_0329.json"
PRIOR = ROOT / "outputs/diagnostics/heartbeat_babilong_20260909_0129.json"
BASELINE_PRIOR = ROOT / "outputs/diagnostics/heartbeat_babilong_20260909_0229.json"
...
already_audited = {(x["task"], x["length"], x["arm"]): x for x in baseline_prior["writeback"]}
ready, pending = {}, []
for task in TASKS:
