...
def main():
    tok=AutoTokenizer.from_pretrained('/srv/encbank/legacy_workspace/models/Qwen3-8B',local_files_only=True);tok.model_max_length=10**9
    ...
    with gzip.open(HERE/'data/clean_samples.jsonl.gz','wt',encoding='utf-8') as out:
        for task in TASKS:
            data=HERE.parent/'encbank_frozen_j12_20260912/data/longbench'/f'{task}.jsonl'
