...
result = {
    ...
    "matrix_cell_format": "Encbank V2 / j0; official accuracy percent; n=100 per method; null means incomplete pair",
    ...
    "protocol": {
        ...
        "generation": "greedy native explicit reader; max_new_tokens=20 (Encbank evaluation setting, not a universal BABILong requirement)",
...
for pair in pairs:
    ...
    try:
        for arm in ARMS:
            ...
            require(receipt["reader"]["class"] == ("EncbankLower" if arm == "fix_all" else "Encbank") and receipt["reader"]["arm"] == arm, "Wrong reader class/arm")
