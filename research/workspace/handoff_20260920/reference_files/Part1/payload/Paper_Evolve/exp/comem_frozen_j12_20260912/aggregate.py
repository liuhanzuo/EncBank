...
summary={'complete':True,'formal_examples':sum(expected.values()),'cells':cell_scores,'scores':scores,'workers':workers,'locomo_source':{'status':'historical full-set frozen j12 Judge','score':24.52,'n':1986,'source':'arXiv tab_depth_tradeoff.tex and designated ARR depth ablation'},'new_input_pairing':'Fresh synthetic inputs; historical itemwise identity not established','scope':'new frozen j12 scores, no new adapter accuracy or infrastructure timing claims'}
