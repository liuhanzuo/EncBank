...
REMOTE = '/data/liuhanzuo/comem_v2_20260908'
...
def sync_once():
    command = f'{REMOTE}/venv/bin/python {REMOTE}/workspace/exp/comem_v2_benchmarks_20260908/collect_report_payload.py'
    ...
    document = [f'# CoMem experiment execution status\n\nUpdated UTC: {now}\n',
        'The target manuscript is COMem/paper_v2_revision_20260907/main.pdf. '
