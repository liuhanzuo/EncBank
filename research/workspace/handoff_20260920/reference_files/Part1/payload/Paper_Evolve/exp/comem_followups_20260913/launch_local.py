...
for number in range(4):
    ...
    args=[sys.executable,'-u',str(HERE/'run_kv_cost.py'),'--model','/srv/encbank/legacy_workspace/models/Qwen3-8B','--adapter',str(HERE.parent/'comem_v2_benchmarks_20260908/checkpoints/8b_j12_pub_4k/final'),'--process',str(number)]
