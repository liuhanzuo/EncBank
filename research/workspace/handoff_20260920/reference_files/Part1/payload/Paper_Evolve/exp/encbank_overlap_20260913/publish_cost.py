...
for cell,label in (('longeval_8k','LongEval 8k'),('longeval_16k','LongEval 16k'),('longeval_32k','LongEval 32k'),('qasper','Qasper')):
    ...
    for a,name in (('replay','Replay'),('w0','Encbank'),('w32',r'Encbank ($w=32$)')):
        r=s['cells'][cell][a]
