...
build = ROOT/'tmp/encbank_infra_20260912/build'
renders = ROOT/'tmp/encbank_infra_20260912/render'
...
for i,page in enumerate(doc):
    ...
    if 'Table 1:' in page_texts[i]:
        assert all(x in page_texts[i] for x in ('Encbank','LongBench','HCache'))
