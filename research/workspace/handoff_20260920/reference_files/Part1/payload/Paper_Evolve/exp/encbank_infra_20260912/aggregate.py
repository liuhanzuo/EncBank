...
lines = ['# 本机补测结果', '', 'RTX 5090；相同 Qwen3-8B + 新训练 final4000 adapter；3 独立进程 × 3 文档 × 20 正式重复。',
         ...
         '|---|---:|---:|---:|---:|---:|']
labels = {'encbank_k12':'Encbank','replay_k12':'Raw replay','replay_k10':'Raw replay'}
tex_rows = []
...
for arm in ('replay_k12', 'replay_k10', 'encbank_k12'):
    v = summary[arm]
    ...
    if arm=='encbank_k12': display_rows.append(r'\rowcolor{resultshade}')
...
import runpy
extended=ROOT/'exp/encbank_infra_128k_20260912'
