...
ALLOWED_ROOT = Path("/data/liuhanzuo/encbank_v2_20260908/models/SmolLM2-1.7B-Instruct--31b70e2e869a")
...
def request(url):
    return urlopen(Request(url, headers={"User-Agent": "Encbank-non-Qwen-fixed-revision-preparation/1"}), timeout=60)
