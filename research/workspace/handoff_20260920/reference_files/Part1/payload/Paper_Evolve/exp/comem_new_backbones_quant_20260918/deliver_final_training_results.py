...
TARGET=ROOT.parent/'comem_new_backbones_formal_20260915/delivery/FIVE_BENCHMARK_RESULTS_zh.md'
def main():
...
| 模型 | CoMem训练版本（H16） | RULER | LongEval | LongBench F1 | BABILong | LoCoMo | Avg. |
|---|---|---:|---:|---:|---:|---:|---:|
'''
