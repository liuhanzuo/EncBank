...
md+=['','共3个新格、329个新预测。pub=原始Encbank，pub_sink=Encbank+BOS，cbos=isolated full KV，不是CacheBlend。实测0保留0，未完成分数为null。','',
     '## RULER：只审新五针128k两格','',
     '原版为0%，BOS为4.4%，均50例。100个raw输出按原Encbank RULER substring-recall评分重算，连续i0–49、完整summary、模型/reader参数、无OOM及远端准入日志均通过；与旧V2/j0的task/length/i/answers/n_tokens和CLI条件逐例一致。V2/replay原已核均值93.2/100未重评分。', '',
