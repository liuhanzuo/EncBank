...
from pathlib import Path
h=Path('/srv/encbank/qencbank_align_codex_20260911/terminal_bench_full89_20260919/server_control_20260920/encbank_vllm_pilot_20260922/attempts/hot_peft_r1')
...
print(json.dumps(r))
'''
r=subprocess.run(['ssh','gpu-node4','/srv/encbank/qencbank_runtime_20260911/python312/bin/python','-'],input=SCRIPT,text=True,encoding='utf-8',capture_output=True,check=True)
