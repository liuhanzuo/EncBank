...
def main():
 ...
 relative='paper_autonomous_multifork_iteration/evidence/encbank_honly_formal_20260911/next_longbench_qa6/hotpot_full200_candidate/package'
 here=root/relative;here.resolve().relative_to(home);root.relative_to(home)
 cache=(home/'qencbank_align_codex_20260911/task_cache/hotpot200_attempt1').resolve();cache.relative_to(home)
