...
def main():
 ...
 assert args.arm=='comem_frozen_j9' and not args.arm.startswith('h')
 ...
 try:
  ...
  with torch.inference_mode(),profiler.phase('outer_model_load_native_quality_and_release'):
   ...
   provenance['executed_attention_policy']=('KIVI SDPA full-document prefill and official Half cached GEMV' if args.arm.startswith('kivi') else 'Native SDPA frozen CoMem j9 iterBM25 selected12; contiguous upper causal recomputation and complete tokenwise query')
