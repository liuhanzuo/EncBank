...
def model_path(plan,part):
    ...
    return p
CONFIG = {'resume_j': 9, 'chunk_size': 512, 'selector': 'iter_bm25', 'topk': 12, 'iter_hop_topk': 4, 'iter_rounds': 0, 'H_group_size': 64, 'KIVI_group_size': 32, 'KIVI_residual_length': 128, 'bos_token_id': 151643, 'eos_token_id': 151645, 'first_step_EOS_suppressed': True, 'max_new_tokens': 48, 'query_tokens_per_call': 1}
