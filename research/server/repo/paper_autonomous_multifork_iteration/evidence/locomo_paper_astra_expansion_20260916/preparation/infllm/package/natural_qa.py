...
def read_natural(method, entry, query_ids, bare_question_ids, *,
    ...
    try:
        ...
        elif not hasattr(request, 'query_position'):
            position_usage = {'mode':'InfLLM_upstream_distance_positions', 'actual_position_counters':'not_exposed_by_native_request', 'logical_consumed_tokens':prefix_tokens+query_calls+decode_calls}
        else:
