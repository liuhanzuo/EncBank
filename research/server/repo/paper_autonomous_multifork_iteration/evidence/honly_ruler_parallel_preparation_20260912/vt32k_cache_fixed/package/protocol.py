...
def preflight(args,envelope=False):
    ...
    assert plan['schema'] == 'RULER_VT32K100_FP16_six_method_remote_quality_v1'
    ...
    for row in items:
        ...
        assert row['dataset'] == 'ruler_variable_tracking_32k' and row['max_new_tokens'] == 60
        ...
        assert token_sha(full) == row['full_prompt_with_BOS_token_sha256'] and len(full)+60 <= 40960
