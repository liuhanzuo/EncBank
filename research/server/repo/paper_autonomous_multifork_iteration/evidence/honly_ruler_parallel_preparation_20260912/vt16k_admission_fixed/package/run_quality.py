"""RULER VT 16K100 grouped entries and variable-length QA; imports no model at module load."""
...
def run(model, tokenizer, fixture, arm, *, plan, output, provenance, profiler, natural_read, kernels=None):
    ...
    result = {'schema':'RULER_VT16K100_FP16_six_method_remote_quality_v1','status':'running','arm':arm,
        ...
        'scope':'New RULER VT 16K100 FP16 controls and KIVI native retrieval quality; no BF16 row reuse, timing or capacity ranking'}
