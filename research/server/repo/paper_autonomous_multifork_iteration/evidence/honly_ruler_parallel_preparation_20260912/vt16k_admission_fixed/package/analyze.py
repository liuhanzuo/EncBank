...
def main():
    ...
    save(args.output,{'status':'complete_six_RULER_VT16K600_answers_600_Writes_3606_phases_pending_parent_shell_Slurm_and_independent_verification',
        ...
        'resampling':plan['analysis'],'scope':'Six new RULER VT16K100 methods, official CoMem generator/scorer; one new cell, no completed old arms rerun, no full15cell macro or fixed infra claim',
