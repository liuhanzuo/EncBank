"""Two-arm KIVI recovery native Slurm bindings; check-only imports no model framework."""
...
def preflight(args,envelope=False):
    ...
    assert plan['schema'] == 'BABILong_qa1_0k_100_FP16_KIVI2_KIVI4_recovery_v1'
    ...
    for row in items:
        ...
        assert row['dataset'] == 'babilong_qa1_0k' and row['max_new_tokens'] == 20
