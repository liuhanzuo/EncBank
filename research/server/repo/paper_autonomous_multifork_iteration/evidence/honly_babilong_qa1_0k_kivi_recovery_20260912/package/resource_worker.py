"""Two-arm KIVI recovery native envelope with unchanged FP16 BABILong driver and timing."""
...
def main():
 ...
 try:
  ...
  with torch.inference_mode(),profiler.phase('outer_model_load_native_quality_and_release'):
   ...
   provenance.update(fixture=plan['fixture'],physical_gpu_identity=identity,resource_policy=RESOURCE,scope='Only fresh KIVI2/KIVI4 BABILong_qa1_0k_100 FP16 recovery in this allocation; Dense/H16/H8/H4 preserved under original plan; natural quality timing with per-run device identity, no fixed-work timing/capacity claim')
