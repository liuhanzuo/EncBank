...
def main():
 ...
 scientific += [ROOT/'tmp_external_baselines/comem_official/eval/_common.py',ROOT/'gpu/kvquant_quality_balanced/phase_profile.py',ROOT/plan['scorer']['path'],ROOT/plan['postprocess']['path']]
 ...
 batch='results/comem-honly-ruler-single2-8k-100-gpu-node1-codex-20260911/attempt1'
