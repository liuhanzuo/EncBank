...
def main():
    ...
    save(args.output,{'status':'complete_LongEval600_answers_600_Writes_3606_phases_pending_parent_shell_Slurm_and_independent_verification',
        ...
        'resampling':plan['analysis'],'scope':'One newly generated LongEval 128K100 matched FP16 block; not five lengths, paper same examples, agent success rate or timing/capacity ranking',
