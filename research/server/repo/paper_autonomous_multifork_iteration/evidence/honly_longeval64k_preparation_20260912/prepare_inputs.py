...
def main():
    ...
    for i in range(100):
        ...
        row = {'id': item_id, 'document_id': doc_id, 'source_ordinal': i,
               ...
               'metadata': {'rng_seed': rng_seed, 'source_length_key': '64k',
                            'source_target_tokens': 65536, 'n_lines': n_lines,
    ...
    save(output / 'inference_fixture.json', {'schema': 'longeval_complete_lines_64k100_input_v1',
         'items': items})
    ...
    manifest = {'status': 'CPU_INPUTS_ONLY_HIGH_POSITION_MODEL_QUALIFICATION_PENDING',
        ...
        'over_nominal_target_including_BOS_query_cap': sum(x['full_prompt_with_BOS_plus_generation_reserve'] > 65536 for x in lengths),
        ...
        'limits': ['One synthetic LongEval 64K cell, not five lengths or paper exact examples.',
                   'Original approximate generator may exceed nominal 65536; no crop.',
