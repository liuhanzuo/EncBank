"""BABILong_qa5_0k_100 grouped entries and variable-length QA; imports no model at module load."""
...
def run(model, tokenizer, fixture, arm, *, plan, output, provenance, profiler, natural_read, kernels=None):
    ...
    result = {'schema':'BABILong_qa5_0k_100_FP16_six_method_native_quality_v1','status':'running','arm':arm,
        ...
        'scope':'New BABILong_qa5_0k_100 FP16 controls and KIVI native retrieval quality; no BF16 row reuse, timing or capacity ranking'}
