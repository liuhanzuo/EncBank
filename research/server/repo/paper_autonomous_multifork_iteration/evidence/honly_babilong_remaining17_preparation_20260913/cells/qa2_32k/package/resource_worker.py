...
def main():
 ...
 try:
  ...
  with torch.inference_mode(),profiler.phase('outer_model_load_native_quality_and_release'):
   ...
   provenance.update(fixture=plan['fixture'],physical_gpu_identity=identity,resource_policy=RESOURCE,scope='Six new BABILong_qa2_32k_100 FP16 arms in one allocation; no 8K result reuse; natural quality timing, no fixed-work timing/capacity claim')
