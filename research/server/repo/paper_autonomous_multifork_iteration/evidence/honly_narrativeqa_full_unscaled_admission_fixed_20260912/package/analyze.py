...
def main():
    ...
    rng=random.Random(20260912);draws=[[rng.randrange(20) for _ in range(20)] for _ in range(10000)]
    contrasts={}
    ...
    save(args.output,{'status':'complete_full_NarrativeQA1200_answers_120_Writes_2886_phases_pending_parent_shell_Slurm_and_independent_verification',
        ...
        'resampling':plan['analysis'],'scope':'Full NarrativeQA200/D20 unscaled extrapolation, official LongBench QA F1/max-reference; no long-item dropping, no full QA6 macro until all common protocol cells complete; natural timing only',
