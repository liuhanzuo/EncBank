...
def model_path(plan,part):
    ...
    return p
CONFIG = {'resume_j': 0, 'chunk_size': 512, 'selector': 'all_chunks', 'topk': None, 'iter_hop_topk': None, 'iter_rounds': None, 'H_group_size': 64, 'KIVI_group_size': 32, 'KIVI_residual_length': 128, 'bos_token_id': 151643, 'eos_token_id': 151645, 'first_step_EOS_suppressed': True, 'max_new_tokens': 64, 'query_tokens_per_call': 1}
...
D=112
PHASES=749
SCHEMA='KVDirect_full_quality_multifieldqa_en_v1'
