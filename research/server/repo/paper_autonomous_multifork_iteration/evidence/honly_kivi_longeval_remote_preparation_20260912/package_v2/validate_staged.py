...
def main():
    ...
    print(json.dumps({'status':'staged_hashes_root_paths_and_two_native_check_only_PASS','plan_sha256':m['plan_sha256'],'model_weights_rehashed':False,'GPU_used':False,'outputs_created':False,'read_only_interpreter':interpreter_identity}))
