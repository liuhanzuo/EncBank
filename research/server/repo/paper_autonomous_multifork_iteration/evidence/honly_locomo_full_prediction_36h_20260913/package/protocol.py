"""Full LoCoMo six-arm native Slurm bindings; check-only imports no model framework."""
...
def preflight(args,envelope=False):
    ...
    assert plan['schema'] == 'full_LoCoMo1986_FP16_six_method_prediction_and_native_lexical_v1'
    ...
    assert plan['expected_total_answers']==11916 and plan['expected_total_Writes']==60 and plan['expected_total_phases']==24078
