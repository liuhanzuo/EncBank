...
def run(model, tokenizer, fixture, arm, *, plan, output, provenance, profiler, natural_read, kernels=None):
    ...
    result = {'schema':'full_2wikimqa200_FP16_six_method_remote_quality_v1','status':'running','arm':arm,
        ...
        'scope':'Full 2WikiMQA200, D200 reused entries; unscaled model and unchanged full inputs, no dropped long rows; natural quality timing only'}
