...
def main():
 ...
 try:
  ...
  with torch.inference_mode(),profiler.phase('outer_model_load_native_quality_and_release'):
   ...
   provenance.update(fixture=plan['fixture'],physical_gpu_identity=identity,resource_policy=RESOURCE,scope='Full HotpotQA200/200 documents, six FP16 methods; original unscaled model with bound17688 input coverage, no YaRN; GPU feasibility unproven until completion')
