...
def main():
    ...
    save(args.output,{'status':'complete_full_MuSiQue1200_answers_1200_Writes_7206_phases_pending_parent_shell_Slurm_and_independent_verification',
        ...
        'resampling':plan['analysis'],'scope':'Full MuSiQue200/D200 unchanged within-window inputs, official LongBench QA F1/max-reference; no long-item dropping, no full QA6 macro until all common protocol cells complete; natural timing only',
