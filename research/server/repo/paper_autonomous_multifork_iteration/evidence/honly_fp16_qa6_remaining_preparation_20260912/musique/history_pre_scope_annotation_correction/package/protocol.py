...
def preflight(args,envelope=False):
    ...
    assert plan['schema'] == 'full_musique200_FP16_six_method_remote_quality_v1'
    ...
    assert coverage['N']==200 and coverage['D']==200 and coverage['max_prompt_plus_cap']==17931
    ...
    for row in items:
        ...
        assert row['dataset'] == 'musique' and row['max_new_tokens'] == 32
        ...
        assert len(full)==expected['full_prompt_tokens_with_BOS'] and len(full)+32==expected['prompt_plus_cap']<=17931
