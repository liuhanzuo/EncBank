...
def main():
    ...
    save(args.output,{'status':'complete_full_Qasper1200_answers_888_Writes_5958_phases_pending_parent_shell_Slurm_and_independent_verification',
        ...
        'resampling':plan['analysis'],'scope':'Full Qasper200/D148 unscaled extrapolation, official LongBench QA F1/max-reference; no long-item dropping, no full QA6 macro until all common protocol cells complete; natural timing only',
