...
def main():
 ...
 try:
  ...
  with torch.inference_mode(),profiler.phase('outer_model_load_native_quality_and_release'):
   ...
   record['unscaled_input_coverage']={'maximum_full_prompt_plus_cap':65457,'fixture':plan['fixture']}
   save(output/'worker.json',record)
   ...
   provenance.update(fixture=plan['fixture'],physical_gpu_identity=identity,resource_policy=RESOURCE,scope='Six new RULER multikey1_64K100 FP16 methods; same input and pinned official scorer; natural quality diagnostics only')
   ...
   provenance['unscaled_coverage']={'maximum_full_prompt_plus_cap':65457,'CPU_qualification':plan['high_position_CPU_qualification'],'effective_model_config':record['effective_model_config'],'original_max_position_embeddings':40960,'original_rope_theta':1000000,'YaRN_or_model_config_override_applied':False}
