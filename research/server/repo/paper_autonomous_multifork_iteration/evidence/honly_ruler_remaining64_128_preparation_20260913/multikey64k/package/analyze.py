...
def main():
    ...
    save(args.output,{'status':'complete_six_RULER_multikey1_64K600_answers_600_Writes_3606_phases_pending_parent_shell_Slurm_and_independent_verification',
        ...
        'resampling':plan['analysis'],'scope':'Six new RULER multikey1_64K100 methods, pinned NVIDIA RULER NIAH generator/scorer+postprocess; one new cell, no completed old arms rerun, no full15cell macro or fixed infra claim',
