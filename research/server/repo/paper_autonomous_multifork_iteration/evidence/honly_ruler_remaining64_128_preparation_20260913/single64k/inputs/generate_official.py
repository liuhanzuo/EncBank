...
config=yaml.safe_load((N/'official_ruler/scripts/synthetic.yaml').read_text())['niah_single_2']
...
args=[str(SRC),'--save_dir',str(save_root),'--save_name','niah_single_2','--subset','validation',
 '--tokenizer_path',str(ROOT/'models/Qwen3-8B'),'--tokenizer_type','hf','--max_seq_length','65536',
...
plan={'status':'FROZEN_BEFORE_NEW_DATA_GENERATION','task':'niah_single_2','official_git_revision':'c3f5e3b4f87f97e048793bb510a3a6b19a46bf3a',
 ...
 'argv':args,'random_seed':42,'PYTHONHASHSEED':42,'official_max_seq_length':65536,'official_generation_reserve':128,'inference_generation_cap':48,
