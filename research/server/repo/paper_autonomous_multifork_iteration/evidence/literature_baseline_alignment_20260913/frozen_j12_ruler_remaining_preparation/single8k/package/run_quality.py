...
def run(model, tokenizer, fixture, arm, *, plan, output, provenance, profiler, natural_read, kernels=None):
    ...
    result = {'schema':'RULER_single2_8K100_FP16_frozen_Encbank_j12_v1','status':'running','arm':arm,
        ...
        'adapter_active':False,'resume_j':12,'scope':'One new frozen Encbank j12 FP16/SDPA Single-needle8K100 cell; no KIVI or other model arm executed; natural diagnostics only'}
