...
def run(model, tokenizer, fixture, arm, *, plan, output, provenance, profiler, natural_read, kernels=None):
    ...
    result = {'schema':'RULER_single64k_100_FP16_frozen_Encbank_j12_v1','status':'running','arm':arm,
        ...
        'scope':'New independent frozen Encbank j12 LoRA OFF single64k100; exact original inputs and cap48; native FP16 SDPA natural quality diagnostics; not a published checkpoint or fixed-work infra claim.'}
