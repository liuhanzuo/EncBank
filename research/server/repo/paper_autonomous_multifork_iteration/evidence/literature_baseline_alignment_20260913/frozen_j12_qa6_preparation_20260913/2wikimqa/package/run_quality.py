...
def run(model, tokenizer, fixture, arm, *, plan, output, provenance, profiler, natural_read, kernels=None):
    ...
    result = {'schema':'full_2wikimqa200_FP16_frozen_Encbank_j12_remote_quality_v1','status':'running','arm':arm,
        ...
        'scope':'New frozen Encbank j12 LoRA OFF 2wikimqa: exact 200 questions/200 documents, cap32, original LongBench QA F1, FP16 native SDPA. Natural timing only; no published checkpoint or fixed-work infrastructure claim.'}
