...
def run(model, tokenizer, fixture, arm, *, plan, output, provenance, profiler, natural_read, kernels=None):
    ...
    result = {'schema':'full_narrativeqa200_FP16_frozen_CoMem_j12_remote_quality_v1','status':'running','arm':arm,
        ...
        'scope':'New frozen CoMem j12 LoRA OFF narrativeqa: exact 200 questions/20 documents, cap128, original LongBench QA F1, FP16 native SDPA. Natural timing only; no published checkpoint or fixed-work infrastructure claim.'}
