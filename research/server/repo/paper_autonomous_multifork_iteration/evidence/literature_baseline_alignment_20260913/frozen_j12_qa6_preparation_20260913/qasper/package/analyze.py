...
def main():
    ...
    contrasts={}
    save(args.output,{'status':'complete_frozen_CoMem_j12_qasper_200_answers_148_Writes_993_phases_pending_parent_shell_Slurm_and_independent_verification',
        ...
        'resampling':plan['analysis'],'scope':'New frozen CoMem j12 LoRA OFF qasper: exact 200 questions/148 documents, cap128, original LongBench QA F1, FP16 native SDPA. Natural timing only; no published checkpoint or fixed-work infrastructure claim.',
