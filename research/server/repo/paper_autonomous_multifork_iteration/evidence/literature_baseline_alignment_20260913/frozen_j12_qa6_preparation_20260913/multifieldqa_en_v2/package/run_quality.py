...
def run(model, tokenizer, fixture, arm, *, plan, output, provenance, profiler, natural_read, kernels=None):
    ...
    result = {'schema':'full_multifieldqa_en150_FP16_frozen_CoMem_j12_remote_quality_v1','status':'running','arm':arm,
        ...
        'scope':'New frozen CoMem j12 LoRA OFF multifieldqa_en: exact 150 questions/112 documents, cap64, original LongBench QA F1, FP16 native SDPA. Natural timing only; no published checkpoint or fixed-work infrastructure claim.'}
