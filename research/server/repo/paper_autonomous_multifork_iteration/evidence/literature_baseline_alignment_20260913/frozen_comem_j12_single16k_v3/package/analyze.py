...
def main():
    ...
    contrasts={}
    save(args.output,{'status':'complete_frozen_CoMem_j12_RULER_single2_16K100_answers_100_Writes_601_phases_pending_parent_shell_Slurm_and_independent_verification',
        ...
        'resampling':plan['analysis'],'scope':'One new frozen CoMem j12 on the exact existing Single-needle16K100 input; same FP16 SDPA, no adapter; original official scoring, no full15 macro or fixed infra claim',
