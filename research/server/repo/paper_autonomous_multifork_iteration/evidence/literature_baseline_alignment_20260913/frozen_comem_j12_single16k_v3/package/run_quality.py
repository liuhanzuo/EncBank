...
def run(model, tokenizer, fixture, arm, *, plan, output, provenance, profiler, natural_read, kernels=None):
    ...
    result = {'schema':'RULER_single2_16K100_FP16_frozen_CoMem_j12_v1','status':'running','arm':arm,
        ...
        'adapter_active':False,'resume_j':12,'scope':'One new frozen CoMem j12 FP16/SDPA Single-needle16K100 cell; no KIVI or other model arm executed; natural diagnostics only'}
