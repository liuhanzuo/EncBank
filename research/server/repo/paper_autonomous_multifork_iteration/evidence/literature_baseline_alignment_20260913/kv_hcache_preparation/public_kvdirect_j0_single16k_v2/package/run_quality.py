...
def run(model, tokenizer, fixture, arm, *, plan, output, provenance, profiler, natural_read, kernels=None):
    ...
    result = {'schema':'RULER_single2_16K100_FP16_public_kvdirect_j0_v1','status':'running','arm':arm,
        ...
        'adapter_active':False,'resume_j':0,'scope':'One new KV-Direct FP16/SDPA Single-needle16K100 cell; no KIVI or other model arm executed; natural diagnostics only'}
