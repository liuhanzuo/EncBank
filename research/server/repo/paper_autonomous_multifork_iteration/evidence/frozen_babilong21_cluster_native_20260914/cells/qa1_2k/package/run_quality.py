...
def run(model, tokenizer, fixture, arm, *, plan, output, provenance, profiler, natural_read, kernels=None):
    ...
    result = {'schema':'BABILong_qa1_2k_100_FP16_frozen_CoMem_j12_remote_v1','status':'running','arm':arm,
        ...
        'scope':'New independent frozen CoMem j12 LoRA OFF qa1_2k100; exact original inputs and cap20; native FP16 SDPA natural quality diagnostics; not a published checkpoint or fixed-work infra claim.'}
