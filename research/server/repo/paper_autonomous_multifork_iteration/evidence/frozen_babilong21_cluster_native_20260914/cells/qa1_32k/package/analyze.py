...
def main():
    ...
    contrasts={}
    save(args.output,{'status':'complete_frozen_Encbank_j12_BABILong_qa1_32k_100_answers_100_Writes_601_phases_pending_parent_shell_Slurm_and_independent_verification',
        ...
        'resampling':plan['analysis'],'scope':'New independent frozen Encbank j12 LoRA OFF qa1_32k100; exact original inputs and cap20; native FP16 SDPA natural quality diagnostics; not a published checkpoint or fixed-work infra claim.',
