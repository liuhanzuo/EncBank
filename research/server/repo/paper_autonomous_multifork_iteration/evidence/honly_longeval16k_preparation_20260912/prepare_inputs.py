...
def main():
    ...
    for i in range(100):
        ...
        assert len(plain_ids) + 1 + 16 <= 40960
        ...
        row = {'id': item_id, 'document_id': doc_id, 'source_ordinal': i,
               ...
               'metadata': {'rng_seed': rng_seed, 'source_length_key': '16k',
                            'source_target_tokens': 16384, 'n_lines': n_lines,
    ...
    save(output / 'inference_fixture.json', {'schema': 'longeval_complete_lines_16k100_input_v1',
         'items': items})
    ...
    manifest = {'status': 'CPU_INPUTS_PREPARED_PENDING_INDEPENDENT_REVIEW_NOT_FORMAL_READY',
        ...
        'limits': ['One synthetic LongEval 16K cell, not five lengths or paper exact examples.',
                   'Original approximate generator may exceed nominal 16384; no crop.',
