"""Remote cc8.9 tiny Half-kernel qualification only; no model imports."""
...
def preflight(args,envelope=False):
    ...
    p=read(args.plan);assert p['schema']=='kivi_half_sm89_remote_tiny_qualification_v1' and p['resource_policy']==RESOURCE
    ...
    assert built['status']=='extension_built_pending_GPU_qualification' and built['actual_exit_code']==0 and built['actual_parent_wait'] and built['process_exit_observed']
    assert built['architecture']=='8.9' and built['GPU_model_or_qualification_executed'] is False
    assert built['binary']['sha256']==p['binary']['sha256']=='3c7f3c093c1e5599ead42036c0e3c5ca11ca21f8dd2dabf13286a31e11326c37'
