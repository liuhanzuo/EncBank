...
OLD = ROOT.parent / 'comem_new_backbones_formal_20260915'
CODEC = Path('/srv/encbank/legacy_workspace/paper_autonomous_multifork_iteration/evidence/comem_honly_formal_20260911/runtime/extracted_minmax.py')
