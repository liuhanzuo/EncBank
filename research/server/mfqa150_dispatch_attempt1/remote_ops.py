...
def main():
 ...
 relative='paper_autonomous_multifork_iteration/evidence/encbank_honly_formal_20260911/next_longbench_qa6/formal_preparation/package'
 here=root/relative;here.resolve().relative_to(home);root.relative_to(home)
 cache=(home/'qencbank_align_codex_20260911/task_cache/mfqa150_attempt1').resolve();cache.relative_to(home)
