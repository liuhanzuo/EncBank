...
CONTROL='/srv/encbank/qcomem_align_codex_20260911/literature_frozen_j12_multikey128k_admission_continuation1_dispatch'
...
def main():
 ...
 if a.mode=='validate':
  ...
  try:
   ...
   assert plan['launch_permitted'] is True and plan['arm_order']==['comem_frozen_j12']
