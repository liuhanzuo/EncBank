...
def main():
 ...
 assert root==Path('/srv/encbank/qcomem_align_codex_20260911/repo') and len(manifest['files'])==30
 relative='paper_autonomous_multifork_iteration/evidence/honly_ruler_multikey_preparation_20260912/package'
 here=root/relative;here.resolve().relative_to(home);root.relative_to(home)
 cache=Path('/srv/encbank/qcomem_align_codex_20260911/task_cache/ruler_multikey8k100_attempt1').resolve();cache.relative_to(home)
