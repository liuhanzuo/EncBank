...
def main():
 ...
 assert root==Path('/srv/encbank/qencbank_align_codex_20260911/repo') and len(manifest['files'])==30
 ...
 cache=Path('/srv/encbank/qencbank_align_codex_20260911/task_cache/ruler_multikey8k100_attempt1').resolve();cache.relative_to(home)
