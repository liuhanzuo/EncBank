...
RELATIVE='paper_autonomous_multifork_iteration/evidence/locomo_paper_astra_expansion_20260916/preparation/frozenj9/package'
REMOTE='/srv/encbank/qencbank_align_codex_20260911/repo'
PYTHON='/srv/encbank/qencbank_runtime_20260911/python312/bin/python'
CONTROL='/srv/encbank/qencbank_align_codex_20260911/locomo_paper_frozenj9_20260916_dispatch_attempt1'
...
def main():
 ...
 if a.mode=='validate':
  ...
  try:
   ...
   assert plan['launch_permitted'] is True and plan['arm_order']==['encbank_frozen_j9']
   ...
   report.update(status='PASS_sparse_files_original_staging_and_one_encbank_frozen_j9_CPU_check',finished_at=now(),resolved_storage_root=str(home),no_model_framework_or_GPU_execution=True)
 ...
 try:
  assert read(control/'package_validation.json')['status']=='PASS_sparse_files_original_staging_and_one_encbank_frozen_j9_CPU_check'
