...
CONTROL='/srv/encbank/qcomem_align_codex_20260911/kivi_longeval8k100_dispatch_attempt2'
...
def main():
 ...
 try:
  ...
  for line in queue['stdout'].splitlines():
   ...
   assert 'qcomem' not in fields[2].lower() and '/qcomem_align_codex_20260911/' not in text,'Another active task-owned GPU/CPU-loading job; inspect before new quality submission'
