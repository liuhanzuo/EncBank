...
p=argparse.ArgumentParser();p.add_argument('--run',required=True);p.add_argument('--model',default='/srv/encbank/encbank_new_backbones_20260915/models/Qwen3.8-27B');a=p.parse_args()
