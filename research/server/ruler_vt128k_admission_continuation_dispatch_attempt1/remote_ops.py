...
RELATIVE='paper_autonomous_multifork_iteration/evidence/honly_ruler_admission_continuations_20260913/vt128k/package'
REMOTE='/srv/encbank/qencbank_align_codex_20260911/repo'
PYTHON='/srv/encbank/qencbank_runtime_20260911/python312/bin/python'
CONTROL='/srv/encbank/qencbank_align_codex_20260911/ruler_vt128k_admission_continuation_dispatch_attempt1'
...
def main():
 ...
 if a.mode=='validate':
  ...
  try:
   ...
   report.update(status='PASS_sparse_files_original_staging_and_6_continuation_CPU_checks',finished_at=now(),resolved_storage_root=str(home),no_model_framework_or_GPU_execution=True)
 ...
 try:
  assert read(control/'package_validation.json')['status']=='PASS_sparse_files_original_staging_and_6_continuation_CPU_checks'
