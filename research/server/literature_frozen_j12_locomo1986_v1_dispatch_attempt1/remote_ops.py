...
RELATIVE='paper_autonomous_multifork_iteration/evidence/literature_baseline_alignment_20260914/frozen_j12_locomo_cluster_native/package'
REMOTE='/srv/encbank/qencbank_align_codex_20260911/repo'
PYTHON='/srv/encbank/qencbank_runtime_20260911/python312/bin/python'
CONTROL='/srv/encbank/qencbank_align_codex_20260911/literature_frozen_j12_locomo1986_v1_dispatch_attempt1'
...
def main():
 ...
 try:
  ...
  assert owned_GPU_requests==0,'Post-owner frozen LoCoMo requires fresh thread requestedGPU0, including pending'
