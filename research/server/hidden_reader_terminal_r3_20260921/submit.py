...
assert not any('bandtb3-' in line for line in queue.splitlines()),'Existing revision3 jobs require review before resubmission'
...
for kind,task in specs:
    name='bandtb3-'+(task[:28] if task else kind)
