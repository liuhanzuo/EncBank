...
with (ROOT.parent/'qencbank_gpu_admission.lock').open('a+b') as lock:
    ...
    assert json.loads((ROOT/'local_gpu_reservation.json').read_text())['token']=='encbank-bge-matched-20260919'
