...
RELATIVE='paper_autonomous_multifork_iteration/evidence/generation_codec_admission_continuation_20260913/package'
REMOTE='/srv/encbank/qencbank_align_codex_20260911/repo'
PYTHON='/srv/encbank/qencbank_runtime_20260911/python312/bin/python'
CONTROL='/srv/encbank/qencbank_align_codex_20260911/generation_codec_admission_continuation_20260913_dispatch_attempt1'
...
def main():
 ...
 if a.mode=='validate':
  ...
  try:
   ...
   assert plan['launch_permitted'] is True and plan['arm_order']==['h16', 'h8', 'h4', 'h4g32', 'h4g128']
   ...
   report.update(status='PASS_sparse_files_original_staging_and_five_CPU_checks',finished_at=now(),resolved_storage_root=str(home),no_model_framework_or_GPU_execution=True)
 ...
 try:
  assert read(control/'package_validation.json')['status']=='PASS_sparse_files_original_staging_and_five_CPU_checks'
