...
def main():
 ...
 assert root==Path('/srv/encbank/qencbank_align_codex_20260911/repo') and len(manifest['files'])==21
 ...
 cache=Path('/srv/encbank/qencbank_align_codex_20260911/task_cache/kivi_cc103_qualification_attempt1').resolve();cache.relative_to(home)
