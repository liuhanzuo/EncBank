...
def main():
 ...
 assert root==Path('/srv/encbank/qcomem_align_codex_20260911/repo') and len(manifest['files'])==20
 ...
 cache=Path('/srv/encbank/qcomem_align_codex_20260911/task_cache/kivi_sm89_qualification_attempt1').resolve();cache.relative_to(home)
